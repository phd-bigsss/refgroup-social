...
mkt_just2.6 <- plm(market ~ diversityclass+isei+income+educ+isei_avg+n_total+age,data=paneldata137,weights = weights1, model="within",effect = "twoways")
screenreg(mkt_just2.6)
