...
elsoc_long_2016_2022.2 <-
  elsoc_long_2016_2022.2 %>% mutate(
    isco88,
    egp11_r_label = isco88_to_egp(x = isco88res_3, self_employed = self_employed_r,n_employees= n_employees_r,label = T),
  )

frq(elsoc_long_2016_2022.2$egp11_r_label)
frq(elsoc_long_2016_2022.2$egp6)
...
elsoc_long_2016_2022.2 %>%
  ...
  summarise(diversityclass=mean(diversityclass,na.rm = T),field="Network diversity") %>% 
    na.omit() %>% 
  ggplot(aes(x=factor(egp5_r),y = diversityclass, group=field, color=field)) +
  geom_point()+
  geom_line() +
...
elsoc_long_2016_2022.2 %>%
  ...
  na.omit() %>% 
  ggplot(aes(x=factor(egp7_r),y = perc, group=Status, color=Status)) +
  geom_point()+
  geom_line() +
  scale_y_continuous(limits = c(10,90),n.breaks = 20) +
  # scale_x_discrete(labels=c("2016","2018","2021")) +
