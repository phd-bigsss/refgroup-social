...
elsoc_long_2016_2022.2$justobrlog <- log(elsoc_long_2016_2022.2$justobr)
...
elsoc_long_2016_2022.2$percgaplog <- log(elsoc_long_2016_2022.2$percgap)
elsoc_long_2016_2022.2$percgaplog <-sjlabelled::set_label(x = elsoc_long_2016_2022.2$percgaplog, label = "Perceived Salary Gap")
...
elsoc_long_2016_2022.2$justgaplog <- log(elsoc_long_2016_2022.2$justgap)
elsoc_long_2016_2022.2$justgaplog <- sjlabelled::set_label(x = elsoc_long_2016_2022.2$justgaplog, label = "Just Salary Gap")
...
elsoc_long_2016_2022.2 %>%
  filter(ola %in% c(5)) %>%
  select(isei_avg,porc_low,porc_middle,porc_high,
...
models1 <- 
list(lme4::lmer(just_pension~porc_low +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(just_pension~ porc_middle + (1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(just_pension~porc_high +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(just_pension~porc_low + porc_middle +porc_high +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(just_pension~porc_low + porc_high + ola + educyear + quintil1 + (1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(just_pension~isei_avg + ola + educyear +(1|idencuesta),data = elsoc_long_2016_2022.2)
     )
screenreg(models1)

models1 <- 
list(lme4::lmer(justgaplog~porc_low +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(justgaplog~ porc_middle + (1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(justgaplog~porc_high +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(justgaplog~porc_low + porc_middle +porc_high +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(justgaplog~porc_low + porc_high + ola + educyear + quintil1 + (1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(justgaplog~ isei_avg + ola + educyear + quintil1 +  n_total + percgaplog +(1 + isei_avg|idencuesta),data = elsoc_long_2016_2022.2)
     )

texreg::screenreg(models1)

elsoc_long_2016_2022.2 %>% 
  filter(ola==1) %>% 
  select(starts_with("prosocial")) %>% 
  sjPlot::tab_corr(triangle = "lower",wrap.labels =25)


models1 <- 
list(lme4::lmer(prosocial5~porc_low +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(prosocial5~ porc_middle + (1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(prosocial5~porc_high +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(prosocial5~porc_low + porc_middle +porc_high +(1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(prosocial5~porc_low + porc_high + ola + educyear + quintil1 + (1|idencuesta),data = elsoc_long_2016_2022.2),
     lme4::lmer(prosocial5~isei_avg + ola + educyear +(1|idencuesta),data = elsoc_long_2016_2022.2)
     )
screenreg(models1)
```
